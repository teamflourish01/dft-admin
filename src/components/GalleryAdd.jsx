...
import { Box, Input, Text, VStack, Button, FormControl, FormLabel, SimpleGrid, Image, IconButton, useToast, Spinner } from '@chakra-ui/react';
...
const GalleryAdd = () => {
    ...
    const handleDelete = (imageUrl) => {
        ...
        setImages(prev => prev.filter((_, index) => imagePreviews[index] !== imageUrl));
    };
